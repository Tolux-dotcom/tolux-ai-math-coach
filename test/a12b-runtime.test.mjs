...
test('A.12B practice saves progress',()=>{assert.match(practice,/practice-alg1-a12b-evaluate-functions/);assert.match(practice,/persistPracticeCompletion/);assert.match(practice,/createPracticeCompletionId/);assert.match(practice,/refreshSession:refreshAuth/);assert.match(practice,/Tolux will retry account sync from the dashboard/);});
